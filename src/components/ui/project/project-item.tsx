		...
		<>
			{projectSize(project) === 'large' ? (
				<ProjectStruct.Container className='w-full h-full'>
					...
					<ProjectStruct.Content className='grid grid-cols-8 gap-12 mb-6 md:mb-12 xl:mb-24 bg-red-500'>
				...
				<ProjectStruct.Container className='w-full h-full'>
					<ProjectHeader project={project} />
					<ProjectStruct.Content className='grid grid-cols-8 gap-12 mb-6 md:mb-12 xl:mb-24 bg-green-500'>
						<div className='col-span-full sm:col-span-4 xl:col-span-2 grid grid-cols-2'>
							<ProjectDescription
								project={project}
								className='col-span-full xl:absolute xl:-top-28 xl:w-2/3 xl:left-1/4'
